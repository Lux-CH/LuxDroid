...
class LuxColors(
    ...
    val systemGroupedBackgroundElevated: Color,
    val secondarySystemGroupedBackgroundElevated: Color,
    val label: Color,
    ...
    companion object {
        fun light(): LuxColors = LuxColors(
            ...
            systemGroupedBackgroundElevated = Color(0xFFF2F2F7),
            secondarySystemGroupedBackgroundElevated = Color(0xFFFFFFFF),
        ...
        fun dark(): LuxColors = LuxColors(
            ...
            systemGroupedBackgroundElevated = Color(0xFF1C1C1E),
            secondarySystemGroupedBackgroundElevated = Color(0xFF2C2C2E),
